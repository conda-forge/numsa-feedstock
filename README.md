...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/numsa-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/numsa-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add numsa numsa-devel
# for installing globally
pixi global install numsa numsa-devel
```
...
It is possible to list all of the versions of `numsa` available on your platform:
...
```
pixi search numsa --channel conda-forge
```
